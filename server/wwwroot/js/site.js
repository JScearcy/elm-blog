...
var _user$project$Main$blogViewHelper = function (blog) {
	return A2(
		_elm_lang$html$Html$a,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$href(blog.url),
				_elm_lang$html$Html_Attributes$class('col-md-3 col-sm-2 blog-container'),
				_elm_lang$html$Html_Attributes$style(
				_elm_lang$core$Native_List.fromArray(
					[
						{ctor: '_Tuple2', _0: 'background-image', _1: 'url(\'https://i.imgur.com/aha9awt.png\')'}
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		A2(_elm_lang$core$List$map, _user$project$Main$blogViewHelper, model.blogs));
};
...
var _user$project$Main$Blog = F3(
	function (a, b, c) {
		return {title: a, url: b, img: c};
	});
